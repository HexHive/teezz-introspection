...
PYTHONPATH=/src python3 -m generator \
    "KeymasterDevice" \
    $TARGET_DIR/hardware/interfaces/keymaster/3.0/default/KeymasterDevice.h \
    ...
    -I$TARGET_DIR/system/core/base/include/ \
...
PYTHONPATH=/src python3 -m generator.geninterceptor \
    /interceptor_configs/keystore_3.0.hi6250.json \
    > interceptor.js
