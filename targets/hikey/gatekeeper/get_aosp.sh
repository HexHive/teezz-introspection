...
# Android/hikey/hikey:9/PQ2A.190305.002/dex11071315:userdebug/test-keys
...
cp -r /target/aosp_gen/android.hardware.gatekeeper@1.0_genc++_headers ./hardware/interfaces/gatekeeper/1.0/
