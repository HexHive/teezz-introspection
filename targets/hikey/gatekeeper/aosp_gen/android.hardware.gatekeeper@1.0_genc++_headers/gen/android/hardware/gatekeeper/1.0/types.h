...
namespace android {
namespace hardware {
template<> struct hidl_enum_iterator<::android::hardware::gatekeeper::V1_0::GatekeeperStatusCode>
{
    const ::android::hardware::gatekeeper::V1_0::GatekeeperStatusCode* begin() { return static_begin(); }
    const ::android::hardware::gatekeeper::V1_0::GatekeeperStatusCode* end() { return begin() + 5; }
    private:
    static const ::android::hardware::gatekeeper::V1_0::GatekeeperStatusCode* static_begin() {
        static const ::android::hardware::gatekeeper::V1_0::GatekeeperStatusCode kVals[5] {
